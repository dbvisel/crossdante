...
var twinmode = __webpack_require__(21);
...
var resize = {
   ...
   */
			...
			if (data.system.responsive) {
				...
				var actualwidth = data.settings.twinmode ? data.windowwidth / 2 : data.windowwidth;
...
var dictionary = {
	...
	initialize: function initialize() {
		...
		for (var i in data.translationdata) {
			...
			if (data.translationdata[i].language) {
				for (var j in dictionary.languages) {
	...
	setup: function setup(side) {

		// setup dictonary halo on a particular text in a lens

		console.log("Dictionary setup called for " + side.translation);
		var textnodes = dictionary.textNodesUnder(side.textinside);
		var _iteratorNormalCompletion = true;
		var _didIteratorError = false;
		var _iteratorError = undefined;

		try {
			for (var _iterator = (0, _getIterator3.default)(textnodes), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		var paragraphs = side.textinside.querySelectorAll("p");
		var _iteratorNormalCompletion2 = true;
		var _didIteratorError2 = false;
		var _iteratorError2 = undefined;

		try {
			for (var _iterator2 = (0, _getIterator3.default)(paragraphs), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	textNodesUnder: function textNodesUnder(el) {
		var n,
		    a = [],
	...
	call: function call(wordtodefine) {
...
var data = __webpack_require__(0);
var fixpadding = __webpack_require__(19);
...
var twinmode = {
	turnon: function turnon() {
		...
		var titlewidth = document.getElementById("navbar").clientWidth / 2 - 5 * 40 - 1;
...
module.exports = {
	...
	__webpack_require__(36), __webpack_require__(34), __webpack_require__(35)]
};
...
var Hammer = __webpack_require__(75);
...
var controls = {
	...
	lefttransplus: function lefttransplus() {
		data.settings.lens = {
	...
	lefttransminus: function lefttransminus() {
		data.settings.lens = {
	...
	leftcantominus: function leftcantominus() {
		data.settings.lens = {
			translation: data.lens.right.translation,
	...
	leftcantoplus: function leftcantoplus() {
		data.settings.lens = {
			translation: data.lens.right.translation,
			canto: parseInt(data.canto) + 1,
			side: "left",
	...
	righttransminus: function righttransminus() {
		data.settings.lens = {
	...
	righttransplus: function righttransplus() {
		data.settings.lens = {
	...
	rightcantominus: function rightcantominus() {
		data.settings.lens = {
			translation: data.lens.right.translation,
			canto: parseInt(data.canto) - 1,
			side: "right",
	...
	rightcantoplus: function rightcantoplus() {
		data.settings.lens = {
			translation: data.lens.right.translation,
			canto: parseInt(data.canto) + 1,
			side: "right",
...
var WatchJS = __webpack_require__(76);

var setlens = __webpack_require__(39);
var setpage = __webpack_require__(40);
var dom = __webpack_require__(1);
var localdata = __webpack_require__(38);
var resize = __webpack_require__(11);
var twinmode = __webpack_require__(21);
var dictionary = __webpack_require__(18);
...
var bookdata = __webpack_require__(32);
